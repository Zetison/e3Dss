# This script adds a static cutted S5 model in Paraview for plotting and a solid static S1 model to enable the plotting made for the timedependent problem of S15 with ESBC
