...
# show data in view
fluid5_time_Display = Show(fluid5_time_, renderView1)
# trace defaults for the display properties.
fluid5_time_Display.Representation = 'Surface'
fluid5_time_Display.ColorArrayName = [None, '']
fluid5_time_Display.OSPRayScaleArray = 'Total scalar field (real)'
fluid5_time_Display.OSPRayScaleFunction = 'PiecewiseFunction'
fluid5_time_Display.SelectOrientationVectors = 'None'
fluid5_time_Display.ScaleFactor = 1.9500000000000002
fluid5_time_Display.SelectScaleArray = 'None'
fluid5_time_Display.GlyphType = 'Arrow'
fluid5_time_Display.PolarAxes = 'PolarAxesRepresentation'
fluid5_time_Display.ScalarOpacityUnitDistance = 0.3874835644455306
fluid5_time_Display.GaussianRadius = 0.9750000000000001
fluid5_time_Display.SetScaleArray = ['POINTS', 'Total scalar field (real)']
fluid5_time_Display.ScaleTransferFunction = 'PiecewiseFunction'
fluid5_time_Display.OpacityArray = ['POINTS', 'Total scalar field (real)']
fluid5_time_Display.OpacityTransferFunction = 'PiecewiseFunction'

# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
fluid5_time_Display.OSPRayScaleFunction.Points = [-0.00206091040046649, 0.0, 0.5, 0.0, -0.00019589119265828528, 0.46875, 0.5, 0.0, 0.0020624312911391206, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
fluid5_time_Display.ScaleTransferFunction.Points = [-0.00206091040046649, 0.0, 0.5, 0.0, -0.00019589119265828528, 0.46875, 0.5, 0.0, 0.0020624312911391206, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
fluid5_time_Display.OpacityTransferFunction.Points = [-0.00206091040046649, 0.0, 0.5, 0.0, -0.00019589119265828528, 0.46875, 0.5, 0.0, 0.0020624312911391206, 1.0, 0.5, 0.0]

def createCuttedDisk(R1,x1,x2,z,resolution):
	# create a new 'Disk'
	disk1 = Disk()
...
x1 = np.sqrt(R1**2-z**2)
x2 = np.sqrt(R2**2-z**2)
createCuttedDisk(R1,x1,x2,z,resolution)
...
# set active source
SetActiveSource(fluid5_time_)

# set scalar coloring
ColorBy(fluid5_time_Display, ('POINTS', 'Total scalar field (real)'))

# rescale color and/or opacity maps used to include current data range
fluid5_time_Display.RescaleTransferFunctionToDataRange(True, False)
