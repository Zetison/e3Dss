...
if length(omega) > 1
    ...
    toggleStressVector = [options.plotStressXX options.plotStressYY options.plotStressZZ options.plotStressYZ options.plotStressXZ options.plotStressXY ...
                          options.plotPolarStress_rr options.plotPolarStress_thetatheta options.plotPolarStress_zz options.plotPolarStress_thetaz options.plotPolarStress_rz options.plotPolarStress_rtheta ...
                          options.plotSphericalStress_rr options.plotSphericalStress_thetatheta options.plotSphericalStress_phiphi options.plotSphericalStress_thetaphi options.plotSphericalStress_rphi options.plotSphericalStress_rtheta...
