function tasks = Fender1972sfa_Fig23(plotResults)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if true
    ...
    tasks(1).SPL = SPL;
    tasks(1).SPL_Fender0 = SPL_Fender0;
    tasks(1).SPL_Fender180 = SPL_Fender180;
end
...
if 1
    ...
    tasks(2).N = N;
    tasks(2).kR = k(~flag)*R_o;
    tasks(2).N_eps = N_eps(~flag);
end
