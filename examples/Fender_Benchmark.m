%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This study correspond to Figure 13a and 13b in Venas2019e3s
...
if true
    ...
    [layer,N_eps] = e3Dss(layer, options);
    toc
    plot(k*R_o, N_eps, 'DisplayName','$N=N_\varepsilon$ needed for convergence of $p_1^{(N_\varepsilon)}$ within machine epsilon precision','color',[178,0,0]/255)
    xlabel('$k_1R_{0,1}$')
    ylabel('$N$')
